...
var results_table: Dictionary = {"level_0": {"time": [500,2000,3000,4000,5000], "alerts": [0,1,2,3,4]},
								...
								"level_5": {"time": [10000,11000,12000,13000,14000], "alerts": [0,2,3,5,7]},
								"level_6": {"time": [12000,13000,14000,15000,16000], "alerts": [0,1,2,3,4]},
								"level_7": {"time": [12000,13000,14000,15000,16000], "alerts": [0,1,2,3,4]}
								}
